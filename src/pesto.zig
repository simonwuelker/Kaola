...
const MIDGAME_PAWN_TABLE = [64]i16{
    0,   0,   0,   0,   0,   0,   0,  0,
...
const ENDGAME_PAWN_TABLE = [64]i16{
    0,   0,   0,   0,   0,   0,   0,   0,
...
const MIDGAME_KNIGHT_TABLE = [64]i16{
...
const ENDGAME_KNIGHT_TABLE = [64]i16{
...
const MIDGAME_BISHOP_TABLE = [64]i16{
...
const ENDGAME_BISHOP_TABLE = [64]i16{
...
const MIDGAME_ROOK_TABLE = [64]i16{
...
const ENDGAME_ROOK_TABLE = [64]i16{
...
const MIDGAME_QUEEN_TABLE = [64]i16{
...
const ENDGAME_QUEEN_TABLE = [64]i16{
...
const MIDGAME_KING_TABLE = [64]i16{
...
const ENDGAME_KING_TABLE = [64]i16{ -74, -35, -18, -18, -11, 15, 4, -17, -12, 17, 14, 17, 17, 38, 23, 11, 10, 17, 23, 15, 20, 45, 44, 13, -8, 22, 24, 27, 26, 33, 26, 3, -18, -4, 21, 24, 27, 23, 9, -11, -19, -3, 11, 21, 23, 16, 7, -9, -27, -11, 4, 13, 14, 4, -5, -17, -53, -34, -21, -11, -28, -14, -24, -43 };

const MIDGAME_VALUE = [6]i16{ 82, 337, 365, 477, 1025, 0 };
const ENDGAME_VALUE = [6]i16{ 94, 281, 297, 512, 936, 0 };

const MIDGAME_TABLE = [6][64]i16{
    MIDGAME_PAWN_TABLE,
